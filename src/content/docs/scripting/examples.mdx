...
Point an IRC client at it, or a sample of malware that beacon's over IRC, and every `PRIVMSG` it sends is captured under an `=== irc ===` section in the artifacts directory.
