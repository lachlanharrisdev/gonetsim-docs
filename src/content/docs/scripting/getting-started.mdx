...
Custom listeners let GoNetSim simulate almost any TCP or UDP protocol, using small scripts written in [Lua](https://www.lua.org). When malware speaks a protocol that DNS or HTTP can't cover, such as SMTP, IRC or a bespoke C2 channel, you can write a handler for it in a few lines.
